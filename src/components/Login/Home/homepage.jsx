...
const HomePage = () => {
  return (
    <div className="w-full flex flex-col md:flex-row bg-[#E7F7F2] rounded-xl p-6 md:p-8">
      {/* Left Section */}
      <div className="flex-1 md:w-1/2 bg-white rounded-lg p-6 flex items-center">
        <div className="flex items-start">
          <div className="mr-4">
            ...
            <button className="mt-4 bg-[#22C55E] text-white font-bold py-2 px-4 rounded flex items-center">
      ...
      <div className="flex flex-col space-y-4 mt-6 md:mt-0 md:ml-6 md:flex-row md:space-y-0 md:space-x-4">
        <div className="flex-1 bg-[#22C55E] text-white rounded-lg p-4 flex flex-col items-center">
        ...
        <div className="flex-1 bg-[#0EA5E9] text-white rounded-lg p-4 flex flex-col items-center">
